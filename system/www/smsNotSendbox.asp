...
var map_code = "";
    var smsmonitor = [<% get_sms(2); %>];
    var smsNotSend = getsms();
...
deleteSelectedSimMsgClickHandler = function() {
    ...
    if (confirm("<#confirm_sms_delete#>")) {
        ...
        for (var i = 0; i < msgIds.length; i++) {
	     ...
	     document.form.current_page.value = "smsNotSendbox.asp";
	     document.form.next_page.value = "smsNotSendbox.asp";
	     document.form.box_type.value = "2";//删除类型 ：发送或者收件箱 
...
function check_full_scan_done() {
    if (nmap_fullscan != "1") {
        ...
        setTimeout("update_smsNotSend();", 2000);
    }
}

var resultMessages = [];
function getAllSMS() {
        resultMessages = parseMessages(smsNotSend);
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box well grad_colour_dark_blue">
                            <h2 class="box_head round_top"><#menu11#> - <#menu5_11_4#></h2>
