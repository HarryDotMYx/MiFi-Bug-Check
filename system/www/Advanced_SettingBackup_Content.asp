...
//		document.form.current_page.value = "Advanced_SettingBackup_Content.asp";
...
function rebootSYSTEM(){
	var alert_string = "<#Main_content_Login_Item7#>";
	if(confirm(alert_string)){
		showLoading();
		set_frm_action_apply(" Reboot ");
		document.form.submit();
	}else
		return false;
}
                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">                                     
                                        ...
                                        <tr id="row_nv_restore1" style="display:none">
                                            ...
                                            <td>
                                                <input name="file_nv" type="file" size="36" style="width: 219px;"/>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th colspan="2" style="background-color: #E3E3E3;"><#SYS_REBOOT#></th>
                                        </tr>
                                        <tr id="row_sys_reboot" style="display:none">
                                            <th width="50%"><#BTN_REBOOT#></th>
                                            <td>
                                                <input name="action3" class="btn btn-danger" style="width: 219px;" onclick="rebootSYSTEM();" type="button" value="<#BTN_REBOOT#>"/>
                                            </td>
                                        </tr>
