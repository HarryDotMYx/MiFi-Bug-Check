...
function applyRule(){
	if(validForm()){
		...
		document.form.action_mode.value = " ApplyIMEI ";
...
<div class="wrapper">
    ...
    <input type="hidden" name="current_page" value="Advanced_MIMEI_Content.asp">
    <input type="hidden" name="next_page" value="">
    <input type="hidden" name="next_host" value="">
    <input type="hidden" name="sid_list" value="LANHostConfig;General;Storage;">
    <input type="hidden" name="group_id" value="">
    <input type="hidden" name="action_mode" value="">
    <input type="hidden" name="action_script" value="sys_settings_imei">
                        ...
                        <div class="box well grad_colour_dark_blue">
                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <div class="alert alert-info" style="margin: 10px;"><#IMEI_MODIFY#></div>

                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th width="50%"><#imei#></th>
                                            <td align="left">
                                            <input type="text" name="imei" id="imei" maxlength="15" class="input" size="15" value="<% nvram_get_x("","imei"); %>">
                                            </td>
                                        </tr>
