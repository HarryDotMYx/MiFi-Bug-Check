...
$j(document).ready(function() {
   // init_itoggle('sp_battle_ips');
    init_itoggle('dms_enable', change_dms_enabled);
});

function change_dms_enabled() {
    var v = document.form.dms_enable[0].checked;
    showhide_div('dmsip', v);
}
</script>
...
<div class="wrapper">
    ...
    <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box well grad_colour_dark_blue">
                            <h2 class="box_head round_top"><#menu5_5#> - <#menu5_5_7#></h2>
       ...
       <!--                                     <th colspan="2" style="background-color: #E3E3E3;"><#IPConnection_BattleNet_sectionname#></th>
                                        ...
                                        <tr>
                                            <th width="50%"><#DMZSettings#></th>
                                            <td>
                                                <div class="main_itoggle">
                                                    <div id="dms_enable_on_of">
                                                        <input type="checkbox" id="dms_enable_fake" <% nvram_match_x("", "dms_enable", "1", "value=1 checked"); %><% nvram_match_x("", "dms_enable", "0", "value=0"); %> />
                                                    </div>
                                                </div>

                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" value="1" name="dms_enable" id="dms_enable_1" <% nvram_match_x("", "dms_enable", "1", "checked"); %>/><#checkbox_Yes#>
                                                    <input type="radio" value="0" name="dms_enable" id="dms_enable_0" <% nvram_match_x("", "dms_enable", "0", "checked"); %>/><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>
                                                                           <!-- <tr>
                                        <th width="50%"><a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,7,21);"><#IPConnection_BattleNet_itemname#></a></th>
                                            <td>
                                                <div class="main_itoggle">
                                                    <div id="dms_on_of">
                                                        <input type="checkbox" id="dms_fake" <% nvram_match_x("", "dms_enable", "1", "value=1 checked"); %><% nvram_match_x("", "dms_enable", "0", "value=0"); %> />
                                                    </div>
                                                </div>

                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" value="1" name="dms_c" id="dms_1" <% nvram_match_x("", "dms_enable", "1", "checked"); %>/><#checkbox_Yes#>
                                                    <input type="radio" value="0" name="dms_c" id="dms_0" <% nvram_match_x("", "dms_enable", "0", "checked"); %>/><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>-->
                                        <tr id="dmsip" style="display:none;">
