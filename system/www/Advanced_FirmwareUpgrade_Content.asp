                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            ...
                                            <td><input type="text" class="input" maxlength="36" size="36" value="<% nvram_get_x("", "computer_name"); %>" readonly="1"></td>
                                        </tr>
                                        <tr>
                                            <th><#FW_item2#></th>
                                            <td><input type="text" name="firmver" class="input" maxlength="36" size="36" value="<% nvram_get_x("",  "fw_ver"); %>" readonly="1"></td>
                                        </tr>
                                        <tr>
                                            <th><#FW_item6#></th>
                                            <td><input type="text" name="firmver" class="input" maxlength="36" size="36" value="<% nvram_get_x("",  "real_ver"); %>" readonly="1"></td>
                                        </tr>
                                        <tr>
                                            <th><#FW_item5#></th>
                                            <td>
