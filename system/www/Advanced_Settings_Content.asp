...
$j(document).ready(function(){
	...
	init_itoggle('nextlevel_bypass_x');
	init_itoggle('ping_check_x');
                        ...
                        <div class="box well grad_colour_dark_blue">
						  ...
						  <td>
						    <select name="operationModeSelect">
												  ...
												  <option value="NR5G-SA" <% nvram_match_x("","operationModeSelect", "NR5G-SA","selected"); %>><#NetworkMode3#></option>
												  <option value="NR5G-NSA+LTE" <% nvram_match_x("","operationModeSelect", "NR5G-NSA+LTE","selected"); %>><#NetworkMode4#></option>
										...
										<th width="50%"><#TTL#></th>
										<td>
										<input type="number" maxlength="3" class="input" size="3" name="fix_ttl" id="fix_ttl" value="<% nvram_get_x("","fix_ttl"); %>" oninput="if(value < 1)value=1;if(value > 256)value=256">
										</td>
										</tr>
                                             <th width="50%"><#Roam#></th>
                                            <td>
										...
										<tr>
                                            <th width="50%"><#Nextlevel_Router_Bypass#></th>
                                            <td>
                                                <div class="main_itoggle">
                                                    <div id="nextlevel_bypass_x_on_of">
                                                        <input type="checkbox" id="nextlevel_bypass_x_fake" <% nvram_match_x("", "nextlevel_bypass_x", "1", "value=1 checked"); %><% nvram_match_x("", "nextlevel_bypass_x", "0", "value=0"); %>>
                                                    </div>
                                                </div>
                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" value="1" name="nextlevel_bypass_x" id="nextlevel_bypass_x_1" <% nvram_match_x("","nextlevel_bypass_x", "1", "checked"); %>/><#checkbox_Yes#>
                                                    <input type="radio" value="0" name="nextlevel_bypass_x" id="nextlevel_bypass_x_0" <% nvram_match_x("","nextlevel_bypass_x", "0", "checked"); %>/><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>
										
										<tr>
                                            <th width="50%"><#PING_CHECK_NETWORK_STATUS#></th>
                                            <td>
                                                <div class="main_itoggle">
                                                    <div id="ping_check_x_on_of">
                                                        <input type="checkbox" id="ping_check_x_fake" <% nvram_match_x("", "ping_check_x", "1", "value=1 checked"); %><% nvram_match_x("", "ping_check_x", "0", "value=0"); %>>
                                                    </div>
                                                </div>
                                                <div style="position: absolute; margin-left: -10000px;">
                                                    <input type="radio" value="1" name="ping_check_x" id="ping_check_x_1" <% nvram_match_x("","ping_check_x", "1", "checked"); %>/><#checkbox_Yes#>
                                                    <input type="radio" value="0" name="ping_check_x" id="ping_check_x_0" <% nvram_match_x("","ping_check_x", "0", "checked"); %>/><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>                                    
                                    <table class="table">
										...
										<tr>
                                            <th  width="50%"><#pdptype#></th>
                                            <td>
                                                <select name="pdptype">
                                                    <option value="0" <% nvram_match_x("", "sim1_pdntype", "0", "selected"); %>>IPV4</option>
                                                    <option value="2" <% nvram_match_x("", "sim1_pdntype", "2", "selected"); %>>IPV6</option>
													<option value="3" <% nvram_match_x("", "sim1_pdntype", "3", "selected"); %>>IPV4V6</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </table>
