...
//			document.form.action_mode.value = " Restart ";
		...
		document.form.group_id.value = "MACList";
...
//		document.form.macfilter_date_x_0.value = (temp_date == '') ? "1111111" : temp_date;
		...
		code +='<tr id="row' + i + '">';
		code +='<td width="50%">&nbsp;' + MACList[i][0] + '</td>';
//		code +='<td width="25%" style="text-align: center;">' + format_time(MACList[i][1]) + '</td>';
//		code +='<td width="45%">' + format_date(MACList[i][2]) + '</td>';
		code +='<td width="50%" style="text-align: right;"><input type="checkbox" name="MFList_s" value="' + i + '" onClick="changeBgColor(this,' + i + ');" id="check' + i + '"></td>';
		code +='</tr>';
	    }
		code += '<tr>';
		code += '<td width="50%">&nbsp;</td>'
		code += '<td width="50%" style="text-align: right;"><button class="btn btn-danger" type="submit" onclick="return markGroupMAC(this, 64, \' Del \');" name="MFList"><i class="icon icon-minus icon-white"></i></button></td>';
		code += '</tr>'
                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <th width="50%" style="border-top: 0 none;"><#FirewallConfig_MFMethod_itemname#></th>
...
<!--                                        <tr id="mac_drop_row" style="display:none;">
                  ...
                  <!--                          <th width="25%"><#MAC_Time#></th>
                                        ...
                                        <tr>
                                            <td width="25%">
                                                ...
                                                <div class="input-append">
                                                    <input type="text" maxlength="12" class="span12" size="12" name="macfilter_list_x_0" value="" onKeyPress="return is_hwaddr(event);" style="float:left; width: 210px">
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 0 none;"><center><input  name="MFList" type="button submit"  type="button" class="btn btn-primary" style="width: 219px" onclick="applyRule();" value="<#CTL_apply#>"/></center></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
